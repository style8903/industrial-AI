...
dis_coefs = np.load('./pinhole_calib/dist_coefs.npy')
...
h_corners = cv2.undistortPoints(corners, camera_matrix, dis_coefs)
...
img_pts,_ = cv2.projectPoints(h_corners, (0,0,0), (0,0,0), camera_matrix, dis_coefs)
